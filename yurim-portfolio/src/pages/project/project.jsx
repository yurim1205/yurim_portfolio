                        ...
                        {selectedProjectDetail && (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-center mt-4 space-x-4 mb-4">
                                    ...
                                    <p className="text-center">
                                        {selectedProjectDetail.teamInfo}
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-col items-center mt-8">
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        {selectedProjectDetail.techStack.map(
                                            (tech, i) => (
                                                <span
                                                    key={i}
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        {selectedProjectDetail.links.map(
                                            (link, i) => (
                                                <a
                                                    key={i}
                                                    href={link.url}
                                    ...
                                    <div className="flex flex-col w-[700px] mx-auto mt-4">
                                        ...
                                        <ul className="list-disc pl-6 mb-4">
                                            {selectedProjectDetail.features.map(
                                                (feat, i) => (
                                                    <li key={i}>{feat}</li>
                                                )
                                            )}
                                        ...
                                        <div className="space-y-2 mb-4">
                                            {selectedProjectDetail.contributions.map(
                                                (contrib, i) => (
                                                    <div key={i}>
